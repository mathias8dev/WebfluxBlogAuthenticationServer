package com.mathias8dev.webfluxblogauthenticationserver.domain.communication.adapters.gson
...
fun LocalDate.toMillisTimestamp(): Long = this.toTimestamp() * 1000

fun LocalDateTime.toTimestampMillis() = this.toTimestamp() * 1000

fun LocalDateTime.atStartOfDay(): LocalDateTime = this.toLocalDate().atStartOfDay()


fun LocalDate.toTimestamp(): Long {
    return this.atStartOfDay().toInstant(ZoneOffset.UTC).epochSecond
}
